...
:::info 版权说明
本文来自 [github 仓库 cpp_new_features](https://github.com/0voice/cpp_new_features)。如果有时间，还是希望读者可以去点个 star
:::
...
* <a href="https://github.com/0voice/cpp_new_features/blob/main/cpp_11/002_grammar_initializer_lists02.cpp">initializer_list(作入参)</a>
